...
public class ProductManager implements ProductService {
	...
	public DataResult<Product> getByProductId(int id) {
		...
		return new SuccessDataResult<Product>(this.productDao.getById(id), "Ürün Başarılı");
	}

	@Override
	public DataResult<List<Product>> findCategory(int categoryId) {
		
		return new SuccessDataResult<List<Product>>(this.productDao.findCategory(categoryId),"Kategori Listelendi");
	}
